...
![](../zPhoto_bin/Pasted%20image%2020260407214437.png)
...
![](../zPhoto_bin/WinNoProtection.gif)
...
![](../zPhoto_bin/WinNoProtectionLog%201.gif)
...
![](../zPhoto_bin/WinWithProtection.gif)
### Dashboard ของ Wazuh
...
![](../zPhoto_bin/WinWithProtectionLog.gif)

ภาพนิ่งจาก Log

![](../zPhoto_bin/02%20Log%201570.png)
...
![](../zPhoto_bin/Pasted%20image%2020260407223607.png)
...
![](../zPhoto_bin/Pasted%20image%2020260409035249.png)
...
![](../zPhoto_bin/Pasted%20image%2020260414012711.png)
...
![](../zPhoto_bin/Shellcode%20run%201.png)

![](../zPhoto_bin/Pasted%20image%2020260412221216.png)
...
ภาพ: **จากล่างขึ้นบน** สังเกตุที่ Frame 11 มีการเรียกใช้ `LoadLibraryEx` ซึ่งเป็น DLL แบบปกติ จุดเริ่มต้นของความล้มเหลว
   ...
   * **Frame 0:** เรียกใช้ `NtFreeVirtualMemory` 
   ...
   กล่าวคือแม้จะไม่ใช่อุปสรรคที่ทำให้ Loader ของเราไม่ทำงานพลาด
